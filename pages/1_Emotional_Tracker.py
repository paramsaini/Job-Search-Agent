...
def emotional_tracker_page():
    ...
    st.markdown(f'<p style="text-align: center; color: #ccc;">Monitor your **Resilience Score** to prevent burnout. Track your **mood** against your **activity** to understand your emotional patterns during the job search.</p>')
    st.markdown("---")
